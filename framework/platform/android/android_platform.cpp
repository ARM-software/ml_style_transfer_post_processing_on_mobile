...
extern "C"
{
	...
	Java_com_arm_style_1transfer_1post_1processing_SampleLauncherActivity_initFilePath(JNIEnv *env, jobject thiz, jstring external_dir, jstring temp_dir)
	{
	...
	Java_com_arm_style_1transfer_1post_1processing_SampleLauncherActivity_getSamples(JNIEnv *env, jobject thiz)
	{
		auto sample_list = apps::get_samples();

		jclass       c             = env->FindClass("com/arm/style_transfer_post_processing/model/Sample");
	...
	JNIEXPORT void JNICALL
	Java_com_arm_style_1transfer_1post_1processing_SampleLauncherActivity_sendArgumentsToPlatform(JNIEnv *env, jobject thiz, jobjectArray arg_strings)
	{
